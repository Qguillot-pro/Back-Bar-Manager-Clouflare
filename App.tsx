  ...
  return (
    <div className={`h-screen flex bg-slate-50 overflow-hidden ${isTestMode ? 'border-4 border-rose-600 box-border' : ''}`}>
      ...
      <main className="flex-1 h-full overflow-y-auto p-4 md:p-8 relative">
          ...
          {view === 'product_knowledge' && <ProductKnowledge sheets={productSheets} items={items} currentUserRole={currentUser.role} onSync={syncData} productTypes={productTypes} glassware={glassware} />}
